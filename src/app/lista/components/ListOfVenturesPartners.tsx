...
export function ListOfVenturesPartners() {
    return (
        <div id="listaparceiros" className="flex justify-center items-center px-2 lg:px-0 py-10 md:py-20 bg-gradient-to-r from-neutral-100 to-neutral-50">
            <div className='md:justify-between flex flex-col justify-items-center md:max-w-6xl w-full gap-3'>
                ...
                <div className="flex items-center justify-between">
                    <h3 className="text-blue-950 text-xl md:text-5xl font-bold py-10">
                        Empreendimentos <span className="text-amber-600">parceiros</span>
                    </h3>
