...
interface OurVenturesProps {
  title: string; // Especifica que title é uma string
  showNavigation?: boolean; // Prop opcional para mostrar as setas
}

export function OurVentures({ title, showNavigation = false }: OurVenturesProps) {
